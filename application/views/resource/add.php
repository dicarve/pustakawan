...
<?php echo create_bootstrap_input('select', 'location', $this->Taxonomy_model->getForSelect('location', 100), 'Publish place', 'chosen', '', isset($record->location)?$record->location:'', '', 'Name of city or place where this resource published') ?>
...
<?php echo create_bootstrap_input('select', 'publisher', $this->Taxonomy_model->getForSelect('publisher', 100), 'Publish place', 'chosen', '', isset($record->publish_place)?$record->publish_place:'', '', 'Name of city or place where this resource published') ?>
